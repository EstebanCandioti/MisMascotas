  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.logout} onPress={() => { void logout(); router.replace("/auth/login"); }}><Ionicons name="log-out-outline" size={21} color="#D8515D" /><Text style={styles.logoutText}>Cerrar sesión</Text></TouchableOpacity>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  iosNotificationSwitch: { transform: [{ translateY: 17 }, { rotate: "0deg" }] }, logout: { height: 52, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderWidth: 1, borderColor: "#F1C9CD", borderRadius: 14, backgroundColor: "#FFF8F8" }, logoutText: { color: "#D8515D", fontSize: 14, fontWeight: "800" },
});
